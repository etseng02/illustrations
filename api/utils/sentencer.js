...
Sentencer.configure({
  ...
  'beer', 'ability', 'village', 'tea', 'grandmother', 'historian', 'desk', 'bacon'],
  ...
  'environmental', 'powerful', 'historical', 'serious', 'pleasant', 'poor', 'boring', 'remarkable', 'important', 'lucky', 'basic', 'old', 'electronic', 'strong'],
  actions: {
    my_action: function(){
      return "something";
    }
